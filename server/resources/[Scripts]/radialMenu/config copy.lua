            ...
            wheels = {                              -- Array of wheels to display
                {
                    ...
                    labels = {"CANCEL", "WAIT", "COP", "TRAFFIC", "SMOKE", "FOLDARMS", "LEAN"},
                    commands = {"e c", "e wait", "e cop", "e copbeacon", "e smoke", "e foldarms", "e lean"}
                },
                {
                    navAngle = 285,                 -- Oritentation of wheel
                    minRadiusPercent = 0.6,         -- Minimum radius of wheel in percentage
                    maxRadiusPercent = 0.9,         -- Maximum radius of wheel in percentage
                    labels = {"CLIPBOARD", "NOTEPAD", "COFFEE", "CUP", "SODA", "CPR", "CPR 2", "GUARD", "CIGAR", "CIGAR 2", "COP 2", "COUNTDOWN", "CRAWL"},
                    commands = {"e clipboard", "e notepad", "e coffee", "e cup", "e soda", "e cpr", "e cpr2", "e guard", "e cigar", "e cigar2", "e cop2", "e countdown", "e crawl"}
                }
            }
        }
    },
            ...
            wheels = {                              -- Array of wheels to display
                {
                    ...
                    maxRadiusPercent = 0.9,         -- Maximum radius of wheel in percentage
                    labels = {"imgsrc:engine.png", "imgsrc:window.png", "imgsrc:trunk.png", "imgsrc:hood.png"},
                    commands = {"engine", "fwindows", "trunk", "hood"}
                }
            }
        }
    }
