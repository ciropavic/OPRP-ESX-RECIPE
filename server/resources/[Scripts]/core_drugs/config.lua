...
Zones = {

	{
		...
		Exclusive = {'weed_seed'} -- Types of drugs that will be affected in this are.
	}
...
Plants = { -- Create seeds for drugs
    ...
    ['weed_seed'] = {
        ...
        Produce = 'weed', -- Item the plant is going to produce when harvested
...
Drugs = { -- Create you own drugs
    ...
    ['weed'] = {
    	...
    	Effects = { -- Effects: runningSSpeedIncrease, infinateStamina, moreStrength, healthRegen, foodRegen, drunkWalk, psycoWalk, outOfBody, cameraShake, fogEffect, confusionEffect, whiteoutEffect, intenseEffect, focusEffect
            'intenseEffect',
            'healthRegen',
            'moreStrength',
            'drunkWalk'
...
Dealers = {
    
        {
            ...
            Heading = 200.0,
            Prices = {
                ['weed'] = 10 -- Item name and price for 1
            }
        }
