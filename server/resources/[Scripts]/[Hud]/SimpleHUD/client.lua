        ...
        if config.voiceRange.enableVoiceRange and ToggleHUD then
            if IsControlJustPressed(0, config.voiceRange.Keybind) then
                if InputWhisper == true then
                    ...
                    MumbleSetAudioOutputDistance(config.voiceRange.NormalDistance)
                ...
                elseif InputNormal == true then
                    ...
                    MumbleSetAudioOutputDistance(config.voiceRange.ShoutingDistance)
                ...
                elseif InputShouting == true then
                    ...
                    MumbleSetAudioOutputDistance(config.voiceRange.WhisperDistance)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
        if ToggleHUD then
            InputText("~b~" .. AreaDisplay, config.display.TimeScale, config.display.TimeLocationX, config.display.TimeLocationY)
            InputText("~r~| ~b~" .. compass .. " ~r~| ~b~" .. streetName, config.display.CompassStreetnameScale, config.display.CompassStreetnameLocationX, config.display.CompassStreetnameLocationY)
            InputText('~r~Nearby Postal: ~b~' .. postal, config.display.PostalScale, config.display.PostalLocationX, config.display.PostalLocationY)
