...
AddEventHandler('inProgress1S', function(street1)
	TriggerClientEvent("gunshotNotify", -1, "~r~[Dispatch] ~w~Gunshot detected: ~y~"..street1)
end)

RegisterServerEvent('inProgress2S')
AddEventHandler('inProgress2S', function(street1, street2)
	TriggerClientEvent("gunshotNotify", -1, "~r~[Dispatch] ~w~Gunshot detected: ~y~"..street1.." ~w~/ ~y~"..street2)
end)
