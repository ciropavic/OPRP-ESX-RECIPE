...
m.messages = {   
    '^6Please read our rules!',
    '^4Join our discord! discord.gg/PEcvuPnguk!',
    '^7Have Fun!',
    '^6Respect Each Other!',
    "^8Don't argue with staff!",
	"^1All of our spawncodes, emotes, etc are on our discord!",
	"^4Please be realistic with your roleplays!",
	"^5Saying 'staff' or 'admin' in chat won't make us go any faster, if you require assistance do /report and an admin will be with you shortly!"
}
