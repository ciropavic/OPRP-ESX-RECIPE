webpackJsonp([0], [, , , , , , function(t, e, n) {
        ...
        A = function() {
            ...
            return g()(t, [{
                ...
                value: function(t) {
                    ...
                    e && (void 0 !== this.soundList[e] ? this.soundList[e].volume = s : (this.soundList[e] = new b.Howl({ src: o, volume: s, loop: !0, onend: function() { this.log("Finished!") } }), this.soundList[e].play()))
                }
            }, {
    ...
    function i(t) {
        ...
        v.locale = "en_US", v.locales = {}, t.prototype.$timeago = { setCurrentLocale: function(t) { v.locale = t }, addLocale: function(t, e) { v.locales[t] = e } }, t.component(i, v)
    }
    e.a = i;
    var a = n(22),
        r = n.n(a),
    ...
    var s = n(12),
        ...
        z = n(217),
        Z = n.n(z);
    s.a.use(o.a), e.a = new o.a({ routes: [{ path: "/", name: "home", component: a.a }, { path: "/menu", name: "menu", component: c.a }, { path: "/contacts", name: "contacts", component: l.a }, { path: "/contact/:id/:number?", name: "contacts.view", component: p.a }, { path: "/messages", name: "messages", component: d.a }, { path: "/messages/select", name: "messages.selectcontact", component: _.a }, { path: "/messages/:number/:display", name: "messages.view", component: g.a }, { path: "/bourse", name: "bourse", component: q.a }, { path: "/bank", name: "bank", component: V.a }, { path: "/photo", name: "photo", component: j.a }, { path: "/paramtre", name: "parametre", component: H.a }, { path: "/appels", name: "appels", component: C.a }, { path: "/appelsactive", name: "appels.active", component: b.a }, { path: "/appelsNumber", name: "appels.number", component: y.a }, { path: "/tchatsplash", name: "tchat", component: T.a }, { path: "/tchat", name: "tchat.channel", component: I.a }, { path: "/tchat/:channel", name: "tchat.channel.show", component: $.a }, { path: "/notes", name: "notes", component: N.a }, { path: "/notes/:channel", name: "notes.channel.show", component: U.a }, { path: "/twitter/splash", name: "twitter.splash", component: O.a }, { path: "/twitter/view", name: "twitter.screen", component: D.a }, { path: "/9gag", name: "9gag", component: Z.a }, { path: "*", redirect: "/" }] })
}, function(t, e, n) {
    function s(t) { n(202) }
        ...
        a = {
            sendpara: function(t, e) {
                ...
                if (7 === i.length) {
                    ...
                    s.a.callEvent("gcphone:bankTransferByPhoneNumber", { phoneNumber: a, amount: o })
                } else s.a.callEvent("gcphone:bankTransferById", { id: i, amount: o })
            }
        },
    ...
    var s = n(31),
        ...
        h = { notesChannels: function(t) { return t.channels }, notesCurrentChannel: function(t) { return t.currentChannel }, notesMessages: function(t) { return t.messagesChannel } },
        p = {
            ...
            notesAddMessage: function(t, e) {
                var n = t.state,
                    ...
                    i = e.message,
                    a = i.channel;
                void 0 !== n.channels.find(function(t) { return t.channel === a }) && (null !== u && (u.pause(), u = null), u = new r.Howl({ src: "/html/static/sound/tchatNotification.ogg", volume: o.volume }), u.play()), s("NOTES_ADD_MESSAGES", { message: i })
            },
        ...
        f = {
            ...
            NOTES_REMOVES_CHANNELS: function(t, e) {
                var n = e.channel;
                t.channels = t.channels.filter(function(t) { return t.channel !== n }), localStorage[c] = i()(t.channels)
            },
            NOTES_REMOVES_ALL_CHANNELS: function(t) { t.channels = [], localStorage[c] = i()(t.channels) },
    ...
    var s = n(21),
        ...
        f = n(12),
        d = n(9),
        m = { show: !1, tempoHide: !1, myPhoneNumber: "###-####", background: JSON.parse(window.localStorage.gc_background || null), coque: JSON.parse(window.localStorage.gc_coque || null), sonido: JSON.parse(window.localStorage.gc_sonido || null), zoom: window.localStorage.gc_zoom || "80%", volume: parseFloat(window.localStorage.gc_volume) || .6, mouse: "true" === window.localStorage.gc_mouse, lang: window.localStorage.gc_language, config: { reseau: "ReIgnited Mobile", useFormatNumberFrance: !1, apps: [], themeColor: "#2A56C6", colors: ["#2A56C6"], language: {} } };
    ...
    var s = n(31),
        ...
        u = null,
        l = { channels: JSON.parse(localStorage[c] || null) || [], currentChannel: null, messagesChannel: [] },
        h = { tchatChannels: function(t) { return t.channels }, tchatCurrentChannel: function(t) { return t.currentChannel }, tchatMessages: function(t) { return t.messagesChannel } },
        p = {
            ...
            tchatAddMessage: function(t, e) {
                var n = t.state,
                    ...
                    i = e.message,
                    a = i.channel;
                void 0 !== n.channels.find(function(t) { return t.channel === a }) && (null !== u && (u.pause(), u = null), u = new r.Howl({ src: "/html/static/sound/tchatNotification.ogg", volume: o.volume }), u.play()), s("TCHAT_ADD_MESSAGES", { message: i })
            },
        ...
        f = {
            ...
            TCHAT_REMOVES_ALL_CHANNELS: function(t) { t.channels = [], localStorage[c] = i()(t.channels) },
    ...
    e.default = {
        ...
        watch: {
            appelsInfo: function(t, e) {
                if (null !== this.appelsInfo && !0 !== this.appelsInfo.is_accepts) { null !== this.soundCall && this.soundCall.pause(); var n = null;!0 === this.appelsInfo.initiator ? (n = "/html/static/sound/Phone_Call_Sound_Effect.ogg", this.soundCall = new c.Howl({ src: n, volume: this.volume, loop: !0, onend: function() { console.log("Finished!") } })) : (n = "/html/static/sound/" + this.sonido.value, this.soundCall = new c.Howl({ src: n, volume: this.volume, loop: !0, onend: function() { console.log("Finished!") } })), this.soundCall.play() } else null !== this.soundCall && (this.soundCall.pause(), this.soundCall = null);
                ...
                return c()(o.a.mark(function n() {
                    ...
                    return o.a.wrap(function(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                s = a()({}, e, { id: t.currentId++, duration: parseInt(e.duration) || 3e3 }), t.list.push(s), window.setTimeout(function() { t.destroy(s.id) }, s.duration), null !== e.sound && void 0 !== e.sound && (i = "/html/static/sound/" + e.sound, r = new l.Howl({ src: i, onend: function() { r.src = null } }), r.play());
                            case 4:
                            case "end":
                                return n.stop()
                        }
    ...
    e.default = {
        ...
        methods: {
            onSelect: function(t) {
                var e = this;
                !0 !== this.ignoreControls && (this.ignoreControls = !0, l.a.CreateModal({ choix: [].concat(o()(t.subMenu), [{ action: "cancel", title: this.IntlString("CANCEL"), icons: "fa-undo" }]) }).then(function(t) {
    ...
    e.default = {
        ...
        methods: l()({}, n.i(h.a)(["startCall", "appelsDeleteHistorique", "appelsDeleteAllHistorique"]), {
            ...
            selectItem: function(t) {
                ...
                return c()(o.a.mark(function n() {
                    ...
                    return o.a.wrap(function(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return s = t.num, i = !1 === s.startsWith("#"), e.ignoreControls = !0, r = [{ id: 1, title: e.IntlString("APP_PHONE_DELETE"), icons: "fa-trash", color: "orange" }, { id: 2, title: e.IntlString("APP_PHONE_DELETE_ALL"), icons: "fa-trash", color: "red" }, { id: 3, title: e.IntlString("APP_PHONE_CANCEL"), icons: "fa-undo" }, { id: 4, title: e.IntlString("APP_PHONE_ADD"), icons: "fa-undo" }], !0 === i && (r = [{ id: 0, title: e.IntlString("APP_PHONE_CALL"), icons: "fa-phone" }].concat(a()(r))), n.next = 7, f.a.CreateModal({ choix: r });
                            case 7:
            ...
            save: function(t) {-1 !== this.id ? this.$router.push({ name: "contacts.view", params: { id: 0, number: t } }) : console.log("No añadido") },
    ...
    var s = n(1),
        ...
        a = n(20),
        r = n.n(a);
    e.default = { components: { InfoBare: r.a }, computed: o()({}, n.i(i.b)(["themeColor"]), { style: function() { return { backgroundColor: this.backgroundColor || this.themeColor, color: this.color || "#FFF" } } }), methods: { back: function() { this.$emit("back") } }, props: { title: { type: String, required: !0 }, showInfoBare: { type: Boolean, default: !0 }, backgroundColor: { type: String } } }
}, function(t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    var s = n(9);
                    ...
                    return o.a.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                ...
                                return e.abrupt("return");
                            case 2:
                                return t.ignoreControls = !0, n = [{ id: 1, title: t.IntlString("APP_DARKTCHAT_NEW_CHANNEL"), icons: "fa-plus", color: "green" }, { id: 2, title: t.IntlString("APP_DARKTCHAT_DELETE_CHANNEL"), icons: "fa-minus", color: "red" }, { id: 3, title: t.IntlString("APP_DARKTCHAT_CANCEL"), icons: "fa-undo" }], 0 === t.tchatChannels.length && n.splice(1, 1), e.next = 7, l.a.CreateModal({ choix: n });
                            case 7:
                                s = e.sent, t.ignoreControls = !1, e.t0 = s.id, e.next = 1 === e.t0 ? 12 : 2 === e.t0 ? 14 : (e.t0, 16);
                                break;
                            case 12:
            ...
            save: function() {
                if (-1 === this.id || 0 === this.id) {
                    ...
                    var t = !0,
                        e = !1,
                        n = void 0;
                    try { for (var s, i = o()(this.contacts); !(t = (s = i.next()).done); t = !0) { var a = s.value; if (a.number === this.contact.number) return this.$phoneAPI.sendGenericError("Cannot add contact. This number is already added as " + a.display) } } catch (t) { e = !0, n = t } finally { try {!t && i.return && i.return() } finally { if (e) throw n } }
                    this.addContact({ display: this.contact.display, number: this.contact.number }), history.back()
                } else {
                    if (!this.contact.number || "" === this.contact.number.trim() || !this.contact.display || "" === this.contact.display.trim()) return;
                    var r = !0,
                        c = !1,
                        u = void 0;
                    try { for (var l, h = o()(this.contacts); !(r = (l = h.next()).done); r = !0) { var p = l.value; if (p.number === this.contact.number) return this.$phoneAPI.sendGenericError("Cannot save contact. This number is already added as " + p.display) } } catch (t) { c = !0, u = t } finally { try {!r && h.return && h.return() } finally { if (c) throw u } }
                    this.updateContact({ id: this.id, display: this.contact.display, number: this.contact.number }), history.back()
                }
            },
    ...
    var s = n(10),
        ...
        u = n.n(c),
        l = n(6);
    e.default = { components: { List: u.a }, data: function() { return { disableList: !1 } }, computed: a()({}, n.i(r.b)(["IntlString", "contacts", "useMouse"]), { lcontacts: function() { return [{ display: this.IntlString("APP_CONTACT_NEW"), letter: "+", num: "", id: -1 }].concat(o()(this.contacts.map(function(t) { return t.backgroundColor = "#2c3e50", t }))) } }), methods: { onSelect: function(t) {-1 === t.id ? this.$router.push({ name: "contacts.view", params: { id: t.id } }) : this.$router.push({ name: "messages.view", params: { number: t.number, display: t.display } }) }, onOption: function(t) { var e = this; - 1 !== t.id && void 0 !== t.id && (this.disableList = !0, l.a.CreateModal({ choix: [{ id: 1, title: this.IntlString("APP_CONTACT_EDIT"), icons: "fa-edit", color: "orange" }, { id: 3, title: this.IntlString("CANCEL"), icons: "fa-undo" }] }).then(function(n) { 1 === n.id && e.$router.push({ path: "contact/" + t.id }), e.disableList = !1 })) }, back: function() {!0 !== this.disableList && this.$router.push({ name: "home" }) } }, created: function() { this.useMouse || this.$bus.$on("keyUpBackspace", this.back) }, beforeDestroy: function() { this.$bus.$off("keyUpBackspace", this.back) } }
}, function(t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    var s = n(10),
            ...
            showOptions: function() {
                ...
                return c()(o.a.mark(function e() {
                    ...
                    return o.a.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return e.prev = 0, t.ignoreControls = !0, n = [{ id: 1, title: t.IntlString("APP_MESSAGE_SEND_GPS"), icons: "fa-location-arrow" }], n.push({ id: 3, title: t.IntlString("APP_MESSAGE_SEND_GPS_REALTIME"), icons: "fa-map-marked-alt" }), t.enableTakePhoto && n.push({ id: 2, title: t.IntlString("APP_MESSAGE_SEND_PHOTO"), icons: "fa-picture-o" }), n.push({ id: -1, title: t.IntlString("CANCEL"), icons: "fa-undo" }), e.next = 8, m.a.CreateModal({ choix: n });
                            case 8:
                                if (s = e.sent, 1 === s.id && t.sendMessage({ phoneNumber: t.phoneNumber, message: "%pos%" }), 2 !== s.id) { e.next = 16; break }
                                return e.next = 13, t.$phoneAPI.takePhoto();
                            case 13:
                                i = e.sent, a = i.url, null !== a && void 0 !== a && t.sendMessage({ phoneNumber: t.phoneNumber, message: a });
                            case 16:
                                if (3 !== s.id) { e.next = 21; break }
                                return e.next = 19, m.a.CreateModal({ choix: [{ id: 6e4, title: t.IntlString("APP_MESSAGE_SEND_GPS_REALTIME_TIME_1") }, { id: 3e5, title: t.IntlString("APP_MESSAGE_SEND_GPS_REALTIME_TIME_2") }, { id: 6e5, title: t.IntlString("APP_MESSAGE_SEND_GPS_REALTIME_TIME_3") }] });
                            case 19:
                    ...
                    n = t.reduce(function(t, n) {
                        if (void 0 === t[n.transmitter]) {
                            var s = { noRead: 0, lastMessage: 0, display: n.transmitter },
                                o = e.find(function(t) { return t.number === n.transmitter });
    ...
    e.default = {
        components: {},
        data: function() { return { STATES: f, state: f.MENU, localAccount: { username: "", password: "", passwordConfirm: "", avatarUrl: "/html/static/img/twitter/default_profile.png" }, notification: 0, notificationSound: !1 } },
    ...
    e.default = {
        ...
        methods: l()({}, n.i(h.a)(["twitterLogin", "twitterPostTweet", "twitterToogleLike", "fetchFavoriteTweets"]), {
            ...
            reply: function(t) {
                ...
                return c()(o.a.mark(function n() {
                    ...
                    return o.a.wrap(function(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return s = t.author, n.prev = 1, e.ignoreControls = !0, n.next = 5, d.a.CreateTextModal({ title: "Reply", text: "@" + s + " " });
                            case 5:
            ...
            formatTime: function(t) { return f()(t).format("HH:mm A on DD/MM") }
        }),
        created: function() { this.useMouse || (this.$bus.$on("keyUpArrowDown", this.onDown), this.$bus.$on("keyUpArrowUp", this.onUp), this.$bus.$on("keyUpEnter", this.onEnter)), this.$bus.$on("keyUpBackspace", this.onBack) },
            ...
            reply: function(t) {
                ...
                return c()(o.a.mark(function n() {
                    ...
                    return o.a.wrap(function(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return s = t.author, n.prev = 1, e.ignoreControls = !0, n.next = 5, d.a.CreateTextModal({ title: e.IntlString("APP_TWITTER_VIEW_REPLY") || "Reply", text: "" });
                            case 5:
                                i = n.sent, void 0 !== i && void 0 !== i.text && (a = i.text.trim(), 0 !== a.length && e.twitterPostTweet({ message: "@" + s + " " + a })), n.next = 12;
                                break;
                            case 9:
    ...
    t.exports = {
        render: function() {
            var t = this,
                e = t.$createElement,
                n = t._self._c || e;
            return n("div", { staticClass: "phone_infoBare barre-header" }, [n("span", { staticClass: "reseau" }, [t._v(t._s(t.config.reseau))]), t._v(" "), n("span", { staticClass: "time" }, [n("current-time")], 1), t._v(" "), n("hr", { staticClass: "batterie1" }), t._v(" "), n("hr", { staticClass: "batterie2" }), t._v(" "), n("hr", { staticClass: "barre1" }), t._v(" "), n("hr", { staticClass: "barre2" }), t._v(" "), n("hr", { staticClass: "barre3" }), t._v(" "), n("hr", { staticClass: "barre4" })])
        },
        staticRenderFns: []
    }
}, function(t, e) {
    ...
    t.exports = {
        ...
        staticRenderFns: [function() {
            var t = this,
                e = t.$createElement,
                n = t._self._c || e;
            return n("div", { staticClass: "splash" }, [n("img", { attrs: { src: "/html/static/img/app_tchat/splashtchat.png", alt: "" } })])
        }]
    }
}, function(t, e) {
    t.exports = {
    ...
    t.exports = {
        render: function() {
            var t = this,
                e = t.$createElement,
                n = t._self._c || e;
            return n("div", [n("list", { attrs: { list: t.contactsList, showHeader: !1 }, on: { select: t.onSelect } })], 1)
        },
        staticRenderFns: []
    }
}, function(t, e) {
