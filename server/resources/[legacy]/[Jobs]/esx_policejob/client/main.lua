...
function OpenFineMenu(player)
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine', {
		...
		elements = {
			...
			{label = "Crimes Against a Person",   value = 1},
			{label = "Crimes Against the Public",   value = 2},
			{label = "Crimes Against Authorities",   value = 3},
			{label = "Weapons Offences",   value = 4},
			{label = "Narcotics Offences",   value = 5}
	}}, function(data, menu)
